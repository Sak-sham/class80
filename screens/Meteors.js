...
import { Text, View, Alert, StyleSheet, SafeAreaView, Platform, StatusBar, Alert, Image, ImageBackground, Dimensions, FlatList } from 'react-native'
                ...
                <ImageBackground source={bg_img} style={styles.backgroundImage}>
                    <View style={styles.gifContainer}>
                        ...
                        <View>
                            ...
                            <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>Missing Earth by (km/h)-{item.close_approach_data[0].miss_distance.kilometers}</Text>
                            </View>
                    </View>
                </ImageBackground>
            </View>
